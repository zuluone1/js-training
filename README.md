[![Build Status](https://travis-ci.org/zuluone1/js-training.svg?branch=master)](https://travis-ci.org/zuluone1/js-training)
## Setup
First, [**fork**](https://github.com/zuluone1/js-training/fork?fragment=1) this repository.
### globals dependencies
install globaly node on your computer

```sh
# download your code locally
git clone https://github.com/zuluone1/js-training.git
# don't forget to remplace zuluone1 by your github login
...
./tester
```
![output-tester](https://github.com/zuluone1/js-training/blob/master/img/output-tester.png)
...
```
![output-node](https://github.com/zuluone1/js-training/blob/master/img/output-node.png)
...
![where-to-code](https://github.com/zuluone1/js-training/blob/master/img/where-to-code.png)

## Get Help !
We maintain an example based code documentation

All you need to know to solve those exercises is described in them.
- [Primitive and Operators](https://github.com/zuluone1/js-training/blob/master/examples/primitive-and-operators.js) [[screencast](https://scrimba.com/c/cwyaEAd)]
- [Variables](https://github.com/zuluone1/js-training/blob/master/examples/variables.js) [[screencast](https://scrimba.com/c/cLrBKA8)]
- [Data-Structures](https://github.com/zuluone1/js-training/blob/master/examples/data-structures.js) [[screencast](https://scrimba.com/c/c9Py3sG)]
- [Get](https://github.com/zuluone1/js-training/blob/master/examples/get.js) [[screencast](https://scrimba.com/c/cvzg2Tq)]
- [Set](https://github.com/zuluone1/js-training/blob/master/examples/set.js) [[screencast](https://scrimba.com/c/cbWrGcg)]
- ...[full list](https://github.com/zuluone1/js-training/tree/master/examples)
...
`[![Build Status](https://travis-ci.org/zuluone1/js-training.svg?branch=master)](https://travis-ci.org/zuluone1/js-training)`
by remplacing zuluone1 by your github login
...
- make a pull request !`https://github.com/zuluone1/js-training/compare/master...zuluone1:master`
